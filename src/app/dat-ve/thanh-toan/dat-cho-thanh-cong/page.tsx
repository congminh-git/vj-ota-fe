...
import FlightInfomation from '@/components/thanh-toan/dat-cho-thanh-cong/thong_tin_chuyen_bay';
import PassengerInfomationBookingSuccess from '@/components/thanh-toan/dat-cho-thanh-cong/thong_tin_hanh_khach';
import ContactInfomationBookingSuccess from '@/components/thanh-toan/dat-cho-thanh-cong/thong_tin_lien_he';
import ReservationInformation from '@/components/thanh-toan/dat-cho-thanh-cong/thong_tin_ve';
...
export default function PaymentSuccessPage() {
    ...
    const viewDetail = () => {
        ...
        router.push(`/quan-ly-dat-cho/chi-tiet-dat-cho?locator=${bookingSuccessResult?.locator}`);
    };
