...
import ListService from '@/components/booking-management/booking-detail/add-on/list_service';
...
export default function AddService() {
    ...
    const listBreadcrumb = [
        ...
        { title: 'Chi tiết booking', uri: `/booking-management/booking-detail/?locator=${bookingSuccessResult?.locator}` },
        { title: 'Thêm dịch vụ', uri: '/booking-management/booking-detail/add-on' },
    ];
    useEffect(() => {
        if (refetch) {
            location.reload();
                    ...
                    <div className="flex flex-wrap justify-center min-h-screen bg-gray-100 border shadow">
                        <div className={` w-full max-w-[1200px]`}>
                            <div className="mt-4 mb-2 flex justify-between items-center">
                                ...
                                <button
                                    onClick={() => {
                                        router.push('/booking-management/booking-detail/?locator=');
                                    }}
