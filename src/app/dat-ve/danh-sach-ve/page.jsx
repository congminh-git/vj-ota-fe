    ...
    const navigateToPassengerInfomationPage = useCallback(() => {
        if (roundTrip) {
            if (
                ...
                const url = `/dat-ve/thong-tin-hanh-khach?cityPair=${cityPair}&departure=${departmentDate}&roundTrip=${roundTrip}&comeback=${returnDate}&currency=${currency}&adultCount=${adult}&childCount=${child}&infantCount=${infant}&departureCity=${departureCity}&arrivalCity=${arrivalCity}&activeSelectFlight=${'đi'}`;
