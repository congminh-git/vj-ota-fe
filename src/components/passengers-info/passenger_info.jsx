                            ...
                            >
                                ...
                                <div className="grid grid-cols-6 sm:gap-8 gap-6">
                                    <div className="col-span-6 sm:col-span-3 w-full h-fit border px-2 py-1 rounded relative">
                                        ...
                                        />
                                        <p
                                            className={`text-red-500 passengers-info-ho-${index} text-sm absolute top-2 right-2`}
                                        ></p>
                                    </div>
                                    <div className="col-span-6 sm:col-span-3 w-full h-fit border px-2 py-1 rounded relative">
                                        <label htmlFor="" className="text-sm text-gray-500 font-medium">
                                        ...
                                        />
                                        <p
                                            className={`text-red-500 passengers-info-ten-dem-ten-${index} text-sm absolute top-2 right-2`}
                                        ></p>
                                    </div>
                                    ...
                                    <div className={`col-span-6 xl:col-span-3 flex flex-col justify-center`}>
                                        ...
                                        <div
                                            className={`flex gap-10 items-center passengers-info-gioi-tinh-${index}`}
                                        >
                                            <label>
                                                <input
                                                    className="mr-2"
                                    ...
                                    <div className="col-span-6 sm:col-span-3 w-full h-fit border px-2 py-1 rounded relative">
                                        ...
                                        <p
                                            className={`text-red-500 passengers-info-id-type-${index} text-sm absolute top-2 right-2`}
                                        ></p>
                                    </div>
                                    <div className="col-span-6 sm:col-span-3 w-full h-fit border px-2 py-1 rounded relative">
                                        <label htmlFor="" className="text-sm text-gray-500 font-medium">
                                        ...
                                        />
                                        <p
                                            className={`text-red-500 passengers-info-passport-${index} text-sm absolute top-2 right-2`}
                                        ></p>
                                    </div>
                                    {index === 0 ? (
                                        <>
                                            <div className="col-span-6 xl:col-span-3 w-full h-fit border px-2 py-1 rounded relative">
                                                ...
                                                <p
                                                    className={`text-red-500 passengers-info-sdt-${index} text-sm absolute top-2 right-2`}
                                                ></p>
                                            </div>
                                            <div className="col-span-6 xl:col-span-3 w-full h-fit border px-2 py-1 rounded relative">
                                                <label htmlFor="" className="text-sm text-gray-500 font-medium">
                                                ...
                                                />
                                                <p
                                                    className={`text-red-500 passengers-info-email-${index} text-sm absolute top-2 right-2`}
                                                ></p>
                                            </div>
                                            <div
                                                className={`${
