...
import PassengersDropDown from '@/components/home-page/dropdown_hanh_khach';
import ListAirport from '@/components/home-page/danh_sach_san_bay';
...
export default function SearchFlightPopup({
    ...
    const searchFlightChange = () => {
        ...
        const url = '/quan-ly-dat-cho/doi-chuyen-bay/danh-sach-ve';
        setSearchParams(
            cityPair,
            departmentDate,
