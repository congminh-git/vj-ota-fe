...
import PassengersInfomation from '@/components/payment/passenger_info';
...
export default function PaymentPage() {
    ...
    const listBreadcrumb = useMemo(
        () => [
            ...
            {
                title: 'Danh sách vé',
                uri: `/booking/select-flight?cityPair=${cityPair}&departure=${departmentDate}&roundTrip=${roundTrip}&comeback=${returnDate}&currency=${currency}&adultCount=${adult}&childCount=${child}&infantCount=${infant}&departureCity=${departureCity}&arrivalCity=${arrivalCity}&activeChonVe=${'đi'}`,
            },
            {
                title: 'Thông tin hành khách',
                uri: `/booking/passengers-info?cityPair=${cityPair}&departure=${departmentDate}&roundTrip=${roundTrip}&comeback=${returnDate}&currency=${currency}&adultCount=${adult}&childCount=${child}&infantCount=${infant}&departureCity=${departureCity}&arrivalCity=${arrivalCity}&activeChonVe=${'đi'}`,
            },
            {
                title: 'Thêm dịch vụ',
                uri: `/booking/add-on`,
            },
            { title: 'Thanh toán', uri: 'payment' },
        ],
    ...
    const isDisabled = paymentMethod.identifier == '' || !agreementCheckbox || (isCardPayment && !isCardInfoValid);
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                <div className="col-span-2">
                                    ...
                                    >
                                        ...
                                        ) : ['AG', 'VI'].includes(paymentMethod.identifier) ||
                                          ((paymentMethod.identifier === 'VJPVI' ||
                                              paymentMethod.identifier === 'VJPMC' ||
                                              paymentMethod.identifier === 'VJPAMEX' ||
                                              paymentMethod.identifier === 'VJPJCB') &&
                                ...
                                <div className="col-span-1">
                                    <PriceInfomation
                                        ...
                                        processingAmount={
                                            quotations?.paymentTransactions[0]?.processingCurrencyAmounts[0]
                                                ?.totalAmount || 0
                                        }
                                    />
